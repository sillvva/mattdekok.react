            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="basis-full md:basis-6/12">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <a href="https://www.linkedin.com/in/matt-dekok/" title="LinkedIn" target="_blank" rel="noreferrer noopener">
                    <svg viewBox="0 0 291 79.459999" className="h-6">
                  ...
                  <a href="https://github.com/sillvva" title="GitHub" target="_blank" rel="noreferrer noopener">
                    <svg viewBox="0 0 560 150" className="h-6">
